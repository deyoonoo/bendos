...
from fake_stake.base_test import BDS_FakeStakeTest

class zBDSwrappedSerialsTest(BDS_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zBDSs..." % DENOM_TO_USE)
