...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BDS features */
        {"bds", "masternode", &masternode, true, true, false},
        {"bds", "listmasternodes", &listmasternodes, true, true, false},
        {"bds", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bds", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bds", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bds", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bds", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bds", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bds", "masternodedebug", &masternodedebug, true, true, false},
        {"bds", "startmasternode", &startmasternode, true, true, false},
        {"bds", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bds", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bds", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bds", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bds", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bds", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bds", "mnbudget", &mnbudget, true, true, false},
        {"bds", "preparebudget", &preparebudget, true, true, false},
        {"bds", "submitbudget", &submitbudget, true, true, false},
        {"bds", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bds", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bds", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bds", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bds", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bds", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bds", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bds", "checkbudgets", &checkbudgets, true, true, false},
        {"bds", "mnsync", &mnsync, true, true, false},
        {"bds", "spork", &spork, true, true, false},
        {"bds", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbdsseed", &getzbdsseed, false, false, true},
        {"zerocoin", "setzbdsseed", &setzbdsseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbds", &searchdzbds, false, false, true},
        {"zerocoin", "dzbdsstate", &dzbdsstate, false, false, true},
...
{
    return "> bds-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:26788/\n";
}
