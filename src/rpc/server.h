...
extern UniValue setzbdsseed(const UniValue& params, bool fHelp);
extern UniValue getzbdsseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbds(const UniValue& params, bool fHelp);
extern UniValue dzbdsstate(const UniValue& params, bool fHelp);
