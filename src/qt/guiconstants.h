...
/* Pny GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BDS"
#define QAPP_ORG_DOMAIN "bds.org"
#define QAPP_APP_NAME_DEFAULT "BDS-Qt"
#define QAPP_APP_NAME_TESTNET "BDS-Qt-testnet"
