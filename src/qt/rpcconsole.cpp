                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBDSPathCustom = GetArg("-zbdsbackuppath", "");
    ...
    if(!strzBDSPathCustom.empty()) {
        ui->wallet_customzbdsbackuppath->setText(QString::fromStdString(strzBDSPathCustom));
        ui->wallet_customzbdsbackuppath_label->setVisible(true);
        ui->wallet_customzbdsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBDSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BDS RPC console.") + "<br>" +
