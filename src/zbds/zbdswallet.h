...
#ifndef BDS_ZBDSWALLET_H
#define BDS_ZBDSWALLET_H
...
public:
    CzBDSWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBDS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBDS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
