...
#ifndef BDS_ZBDSTRACKER_H
#define BDS_ZBDSTRACKER_H
...
public:
    CzBDSTracker(std::string strWalletFile);
    ~CzBDSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBDSWallet* zBDSWallet = NULL);
