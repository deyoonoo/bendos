Contributing to BDS Core
============================

The BDS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BDS Core project, and is not to be
confused with overall BDS Network Protocol consensus changes.

Whether a pull request is merged into BDS Core rests with the project merge
...
Patches that change BDS consensus rules are considerably more involved than
...
Where a patch set proposes to change the BDS consensus, it must have been
...
The project leader is the release manager for each BDS Core release.
