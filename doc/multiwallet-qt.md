...
In order to support loading of multiple wallets in bds-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bds.cpp.
...
Changes to bds.cpp
----------------------
bds.cpp is the entry point into bds-qt, and as such, will require some minor modifications to provide hooks for
