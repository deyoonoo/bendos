...
RESOURCES += src/qt/bds.qrc src/qt/bds_locale.qrc

TRANSLATIONS += src/qt/locale/bds_bg.ts \
                src/qt/locale/bds_de.ts \
                src/qt/locale/bds_en.ts \
                src/qt/locale/bds_es.ts \
                src/qt/locale/bds_fi.ts \
                src/qt/locale/bds_fr.ts \
                src/qt/locale/bds_it.ts \
                src/qt/locale/bds_ja.ts \
                src/qt/locale/bds_pl.ts \
                src/qt/locale/bds_pt.ts \
                src/qt/locale/bds_ru.ts \
                src/qt/locale/bds_sk.ts \
                src/qt/locale/bds_sv.ts \
                src/qt/locale/bds_vi.ts \
                src/qt/locale/bds_zh_CN.ts \
                src/qt/locale/bds_zh_TW.ts
